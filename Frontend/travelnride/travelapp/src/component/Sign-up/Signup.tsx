    ...
    <div className="flex flex-col md:flex-row">
      <div className="w-full md:w-1/2 pr-0 md:pr-6">
        <div className="mb-6">
          ...
          <h1 className="text-2xl font-bold text-[#112211] mb-1">Sign up</h1>
        ...
        <form className="space-y-3">
          ...
          <div className="flex items-center">
            <input type="checkbox" id="terms" className="w-4 h-4 border-[#79747e] rounded focus:ring-[#8dd3bb]" />
            <label htmlFor="terms" className="ml-2 text-xs text-[#112211]">
              I agree to all the{" "}
